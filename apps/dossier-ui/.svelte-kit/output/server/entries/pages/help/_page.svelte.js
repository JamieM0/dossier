import { c as attr_class, d as attr, a as ensure_array_like, e as escape_html } from "../../../chunks/index.js";
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    const groups = [
      ...
      },
      {
        ...
        shortcuts: [
          ...
          {
            keys: "Escape",
            description: "Return focus to sidebar (if input empty)"
          }
        ]
      },
      {
    ...
    $$renderer2.push(`<section class="help-view svelte-1vby5nc"><div class="help-content svelte-1vby5nc"><h1 class="page-heading svelte-1vby5nc">Help</h1> <div class="help-tabs svelte-1vby5nc" role="tablist"><button${attr_class("tab svelte-1vby5nc", void 0, { "active": activeTab === "shortcuts" })} role="tab"${attr("aria-selected", activeTab === "shortcuts")}>Keyboard Shortcuts</button> <button${attr_class("tab svelte-1vby5nc", void 0, { "active": activeTab === "getting-started" })} role="tab"${attr("aria-selected", activeTab === "getting-started")}>Getting Started</button> <button${attr_class("tab svelte-1vby5nc", void 0, { "active": activeTab === "about" })} role="tab"${attr("aria-selected", activeTab === "about")}>About Dossier</button></div> `);
    {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<div class="shortcuts-view svelte-1vby5nc" role="tabpanel"><!--[-->`);
      ...
      for (let $$index_2 = 0, $$length = each_array.length; $$index_2 < $$length; $$index_2++) {
        ...
        for (let $$index_1 = 0, $$length2 = each_array_1.length; $$index_1 < $$length2; $$index_1++) {
          ...
          const each_array_2 = ensure_array_like(shortcut.keys.split(" + "));
          for (let i = 0, $$length3 = each_array_2.length; i < $$length3; i++) {
            ...
            $$renderer2.push(`<!--]--> <kbd>${escape_html(key.trim())}</kbd>`);
          }
